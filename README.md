...
| <a name="input_subnets"></a> [subnets](#input\_subnets) | (Required) A list of subnets to create within the Virtual Network. | <pre>list(object({<br>    name             = string<br>    address_prefixes = list(string)<br>    subnet_delegations = optional(list(object({<br>      name            = string<br>      service_name    = string<br>      service_actions = optional(list(string), null)<br>    })), null)<br>    private_endpoint_network_policies_enabled     = optional(bool, true)<br>    private_link_service_network_policies_enabled = optional(bool, true)<br>    service_endpoints                             = optional(list(string), null)<br>    service_endpoint_policy_ids                   = optional(list(string), null)<br>  }))</pre> | n/a | yes |
